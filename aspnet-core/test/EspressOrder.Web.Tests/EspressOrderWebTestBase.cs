...
{
    public abstract class EspressOrderWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EspressOrderWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EspressOrderWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EspressOrderDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EspressOrderDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EspressOrderDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EspressOrderDbContext, Task<T>> func)
        {
            T result;
